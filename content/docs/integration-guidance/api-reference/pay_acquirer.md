...
| local_amount | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Fiat amount of the sale, in the settlement currency. |
...
| fx_rate | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Units of local_currency per 1 USDt, set by the Acquirer. |
...
| local_amount | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Fiat amount of the sale. |
| fx_rate | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Units of local_currency per 1 USDt locked for this intent. |
| amount_usdt | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Exact amount the customer pays, round(local_amount / fx_rate, 2dp, half-up). |
...
| local_amount | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Fiat amount the merchant wants to price. |
...
| amount_usdt | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | USDt the customer pays for local_amount at fx_rate. |
| fx_rate | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Standing quote's rate, in units of local_currency per 1 USDt. |
...
| settlement_amount | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Amount the Acquirer actually received; currency set by the settlement variant. |
...
| settlement_amount | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Fiat amount the LP transferred. |
...
| amount_received | [Decimal](../pay_types/#tzero-v1-pay-Decimal) |  | Fiat amount credited to the Acquirer's account. |
